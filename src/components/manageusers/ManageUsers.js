                    ...
                    <div className="card">
                        ...
                        <div className="search-box">
                            <div className="search-box-child">
                                <h3 className="first" style={{ marginRight: '10px' }}>Usuário</h3>
                ...
                <div className="p-col-12">
                    <div className="card">
                        <DataTable value={this.state.locations} paginator={true} rows={10} rowsPerPageOptions={[10, 30, 50, 100]}>
                            ...
                            <Column field="User" header="Usuário" sortable={true} />
                            <Column field="HierarchyLevel" header="Nível de Hierarquia" sortable={true} />
